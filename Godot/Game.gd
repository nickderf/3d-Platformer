...
#levels
onready var levels = [preload("res://Levels/Level1.tscn"),preload("res://Levels/Level2.tscn"),preload("res://Levels/Level3.tscn"),preload("res://Levels/Level4.tscn")]
#objects 
...
func _ready():
	CURRENT_LEVEL = preload("res://Levels/Level1.tscn")
	add_child(inv)
